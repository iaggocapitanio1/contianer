...
class RentPeriodBalance(models.Model):
    ...
    transaction_type = fields.ForeignKeyField("models.TransactionType", related_name="rent_period_balance", null=True)
    order_credit_card = fields.ForeignKeyField("models.OrderCreditCard", related_name="rent_period_balance", null=True)

    class Meta:
        table = "rent_period_balance"
